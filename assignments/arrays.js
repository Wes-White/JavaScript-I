...
let lastCar = 0;
console.log(`Last car is a ${inventory[49].car_make} ${inventory[49].car_model}`);
...
for(let i =0; i <inventory.length; i++){ 
    ...
    carYears.push(year);
    carYears.sort()  //I used sort to see if it will work with intergers and not just strings
}
